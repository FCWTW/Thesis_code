...
# https://github.com/huggingface/pytorch-image-models/blob/24fc720d3490a2a4f432bf166a38a1fd4b506b3b/timm/layers/drop.py#L137
...
# https://github.com/huggingface/pytorch-image-models/blob/24fc720d3490a2a4f432bf166a38a1fd4b506b3b/timm/layers/drop.py#L157
...
# https://github.com/huggingface/pytorch-image-models/blob/24fc720d3490a2a4f432bf166a38a1fd4b506b3b/timm/layers/weight_init.py#L43
...
class SwinTransformer3DBackbone(nn.Module):
    """
    A wrapper for Video-Swin Transformer.
    Modified from https://github.com/wjn922/ReferFormer/blob/main/models/video_swin_transformer.py
    """

    def __init__(self,
                 # backbone_pretrained=True, # use pretrained weights
                 # backbone_pretrained_path=None, # path to pretrained weights
                 pretrained=False,
                 train_backbone=False, # train backbone weights
                 **kwargs):
        ...
        # swin_backbone = SwinTransformer3D(pretrained=file_weight, **kwargs)
        ...
        self.layer_output_channels = [self.swin_backbone.embed_dim * 2 ** i for i in range(len(self.layers))]
    ...
    def load_weights(self):
        ...
        if os.path.isfile(file_weight):
            print (f'-> Loading weight file {file_weight}')
            weight_dict = torch.load(file_weight)['state_dict']
